...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    organization: "BCC Fakultas Ilmu Komputer Universitas Brawijaya",
    type: "volunteer",
    startDate: "2025-03",
    endDate: "2025-12",
    description:
  ...
  },
  {
    ...
    organization:
      "Himpunan Mahasiswa Departemen Teknik Informatika (HMDTIF) FILKOM UB",
    type: "volunteer",
    startDate: "2025-01",
    endDate: "2025-12",
    description:
  ...
  },
  {
    ...
    technologies: ["Go", "PostgreSQL", "REST API", "Testing"],
    highlights: [
